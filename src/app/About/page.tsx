        ...
        <>
            <section className="w-full pb-12 flex flex-col justify-center items-center px-6 md:px-10 lg:h-auto lg:px-20 bg-[#ff660b]">
                <h1 className="text-center text-xl sm:text-2xl md:text-4xl w-full py-6 text-[#fff] lg:h-auto leading-[40px] md:leading-[65px]">
                    Your Sarthi for Foundation/NEET/JEE/CUET Preparation
                </h1>
...
=======
                        ...
                        <br /><br />
                        Location:
                        Medhavi Ranchi is conveniently located in Hariom Tower, Ranchi, Jharkhand, making it easily accessible for students across the region.
                    </p>
                </div>
            </section>
        </>
